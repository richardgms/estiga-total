...
import { FaCertificate, FaDumbbell, FaClock } from 'react-icons/fa';
...
const BenefitCard: React.FC<{ benefit: Benefit }> = ({ benefit }) => {
  return (
    <div className="group relative bg-white rounded-2xl p-6 md:p-8 border border-gray-100 hover:border-secondary-orange/50 transition-all duration-300 hover:shadow-2xl hover:shadow-secondary-orange/20 hover:-translate-y-2">
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        ...
        <h3 className="text-xl sm:text-2xl font-bold text-primary mb-4 group-hover:text-secondary-orange transition-colors duration-300">
          {benefit.title}
        </h3>
